...
flags.DEFINE_string('ref_genome_fa', '../genomes/hg19_chr19_chr21_chr22.fa', 'The reference genome of human.')
flags.DEFINE_string('ref_genome_size', '../genomes/hg19.autoX.chrom.sizes', 'The size of human reference genome.')
